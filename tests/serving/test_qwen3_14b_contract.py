...
def test_registry_resolves_explicit_qwen3_14b_contract() -> None:
    ...
    assert sorted(contract.kernels) == ["decode", "greedy_sample", "prefill", "token_embed"]
...
def test_stage_arg_specs_match_host_wrapper_signatures() -> None:
    ...
    for stage in contract.kernels.values():
        ...
        assert tuple(arg.name for arg in stage.args) == signature_names
...
def test_compile_arg_builders_follow_stage_specs() -> None:
    ...
    token_embed_args = contract.kernels["token_embed"].compile_args_builder(model_config, runtime_config)
    ...
    assert [tuple(arg.shape) for arg in token_embed_args] == [(16, 8), (512, 8), (16, 8)]
...
def test_kernel_validator_accepts_matching_metadata() -> None:
    ...
    loaded = LoadedKernelModules(
        ...
        constants={
            ...
            "decode_max_seq": 4096,
            "decode_vocab": 152064,
            "decode_real_vocab": 151936,
            "decode_num_layers": 40,
            "decode_sampled_ids_pad": 8,
            "greedy_sample_batch": 16,
            "greedy_sample_vocab": 152064,
            "greedy_sample_sampled_ids_pad": 8,
            "token_embed_batch": 16,
            "token_embed_vocab": 152064,
            "token_embed_hidden": 5120,
        },
    )
